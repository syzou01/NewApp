...
public class NotificationActivity extends AppCompatActivity implements View.OnClickListener, Runnable, AdapterView.OnItemClickListener {
    ...
    public void onClick(View v) {
        ...
        //列表
        mListView = findViewById(R.id.List);
        mAdapter = new ArrayAdapter(NotificationActivity.this,android.R.layout.simple_list_item_1,data);
        mListView.setAdapter(mAdapter);

        //没有内容的Toast
        if(data.isEmpty()){
            Toast.makeText(NotificationActivity.this,"没有找到您需要的信息！",Toast.LENGTH_SHORT).show();
        }
    }
